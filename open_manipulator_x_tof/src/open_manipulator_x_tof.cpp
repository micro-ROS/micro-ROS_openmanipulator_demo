...
: Node("open_manipulator_x_tof")
{
  ...
  ********************************************************************************/
  ...
  joint_states_sub_ = this->create_subscription<sensor_msgs::msg::JointState>(
    "joint_states", qos, std::bind(&OpenManipulatorXToFDemo::joint_states_callback, this, _1));
  kinematics_pose_sub_ = this->create_subscription<open_manipulator_msgs::msg::KinematicsPose>(
    "kinematics_pose", qos, std::bind(&OpenManipulatorXToFDemo::kinematics_pose_callback, this, _1));
